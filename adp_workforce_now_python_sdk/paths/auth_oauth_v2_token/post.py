...
class BaseApi(api_client.Api):
    ...
    def _create_with_authorization_header_mapped_args(
        self,
        ...
        if grant_type is not None:
            _query_params["grant_type"] = grant_type
    ...
    async def _acreate_with_authorization_header_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/auth/oauth/v2/token',
            body=body,
            headers=_headers,
        )
    ...
    def _create_with_authorization_header_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateWithAuthorizationHeaderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_with_authorization_header(
        self,
        grant_type: typing.Optional[str] = None,
        client_id: typing.Optional[str] = None,
        client_secret: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_with_authorization_header_mapped_args(
            body=body,
            grant_type=grant_type,
            client_id=client_id,
            client_secret=client_secret,
        )
        return await self._acreate_with_authorization_header_oapg(
            body=args.body,
            query_params=args.query,
            **kwargs,
        )
    
    def create_with_authorization_header(
        self,
        grant_type: typing.Optional[str] = None,
        client_id: typing.Optional[str] = None,
        client_secret: typing.Optional[str] = None,
        ...
        return self._create_with_authorization_header_oapg(
            body=args.body,
            query_params=args.query,
        )

class CreateWithAuthorizationHeader(BaseApi):
    ...
    async def acreate_with_authorization_header(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_with_authorization_header(
            body=body,
            grant_type=grant_type,
            client_id=client_id,
            client_secret=client_secret,
    ...
    def create_with_authorization_header(
        ...
        raw_response = self.raw.create_with_authorization_header(
            body=body,
            grant_type=grant_type,
            client_id=client_id,
            client_secret=client_secret,
